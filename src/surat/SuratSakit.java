...
public final class SuratSakit extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TanggalAkhir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-06-2025" }));
        ...
        TanggalAwal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-06-2025" }));
    ...
    private void MnCetakSuratSakit5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSakit5ActionPerformed
        if(TPasien.getText().trim().equals("")){
            ...
            param.put("finger","http://apps.rspelitakasih.id/verify/?id="+EnkripsiAES.encrypt("{'x':'sks','t':'"+NoSurat.getText()+"'}"));
